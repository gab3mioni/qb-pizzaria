...
function MakeMozzarella()
    ...
    QBCore.Functions.Progressbar("pickup_sla", "Montando Pizza", 4000, false, true, {
...
function MakePeperoni()
    ...
    TriggerServerEvent('QBCore:Server:RemoveItem', "massapizza", 1)
    TriggerServerEvent('QBCore:Server:RemoveItem', "molhotomate", 1)
    TriggerServerEvent('QBCore:Server:RemoveItem', "calabresa", 2)
    TriggerServerEvent('QBCore:Server:RemoveItem', "cebolac", 2)
    TriggerServerEvent('QBCore:Server:RemoveItem', "queijo", 2)
    QBCore.Functions.Progressbar("pickup_sla", "Montando Pizza", 4000, false, true, {
        disableMovement = true,
        disableCarMovement = false,
...
function MakeBroccoli()
    ...
    TriggerServerEvent('QBCore:Server:RemoveItem', "massapizza", 1)
    TriggerServerEvent('QBCore:Server:RemoveItem', "molhotomate", 1)
    TriggerServerEvent('QBCore:Server:RemoveItem', "brocolis", 2)
    TriggerServerEvent('QBCore:Server:RemoveItem', "queijo", 2)
    QBCore.Functions.Progressbar("pickup_sla", "Montando Pizza", 4000, false, true, {
        disableMovement = true,
        disableCarMovement = false,
...
function MakeMassa()
    ...
    TriggerServerEvent('QBCore:Server:RemoveItem', "farinhatrigo", 4)
    TriggerServerEvent('QBCore:Server:RemoveItem', "oleo", 4)
    TriggerServerEvent('QBCore:Server:RemoveItem', "fermento", 1)
    TriggerServerEvent('QBCore:Server:RemoveItem', "sal", 2)
    TriggerServerEvent('QBCore:Server:RemoveItem', "ovo", 2)  
    QBCore.Functions.Progressbar("pickup_sla", "Sovando Massa", 4000, false, true, {
        disableMovement = true,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = false,
...
function MakeGuarana()
    ...
    QBCore.Functions.Progressbar("pickup", "Enchendo o copo..", 4000, false, true, {
        disableMovement = true,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = false,
...
function MakeVinho()
    ...
    QBCore.Functions.Progressbar("pickup", "Enchendo a taça..", 4000, false, true, {
        disableMovement = true,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = false,
