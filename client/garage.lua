...
RegisterNetEvent('qb-pizzaria:garage')
AddEventHandler('qb-pizzaria:garage', function(bs)
    ...
    QBCore.Functions.GetPlayerData(function(PlayerData)
        if PlayerData.job.name == "pizzaria" then
            ...
            QBCore.Functions.Notify('You are not an employee of Luchettis.', 'error')
            
        end
    end)    
end)

RegisterNetEvent('qb-pizzaria:storecar')
AddEventHandler('qb-pizzaria:storecar', function()
...
RegisterNetEvent('garage:PizzariaGarage', function()
    TriggerEvent('qb-menu:sendMenu', {
        {
            id = 1,
            header = "| Luchetti's Garage |",
            txt = ""
        },
        {
            id = 2,
